package me.lavainmc.zerohunt.commands;

import me.lavainmc.zerohunt.ZeroHunt;
import me.lavainmc.zerohunt.managers.GameManager;
...
public class Commands implements CommandExecutor {
    ...
    public Commands(ZeroHunt plugin) {
        this.plugin = plugin;
    ...
    private void handleSetRoleCommand(CommandSender sender, String[] args) {
        if (!sender.hasPermission("zerohunt.command.admin")) {
    ...
    private void help(CommandSender sender) {
        sender.sendMessage(ChatColor.GOLD + "=== ZeroHunt 命令帮助 ===");
        sender.sendMessage(ChatColor.YELLOW + "/zerohunt start - 开始游戏");
        sender.sendMessage(ChatColor.YELLOW + "/zerohunt stop - 结束游戏");
        sender.sendMessage(ChatColor.YELLOW + "/zerohunt status - 查看游戏状态");
        sender.sendMessage(ChatColor.YELLOW + "/zerohunt reset - 重置末地世界(admin权限)");
    }
}
